...
testthat::test_that("check_secret_entry_exists works", {
  ...
  # Check value
  keyring_block_list <- list(
    "service" = "database",
    "username" = temp_username
  )
  keyring_block_list_garbage <- list(
    "service" = "asdwadsda",
    "username" = "qawdasd"
  )
  keyring_block_service_nonuser <- list(
    "service" = "database",
    "username" = "qawdasd"
  )
  keyring_value_true <- check_secret_entry_exists(
    keyring_block_list
  )
  keyring_value_false <- check_secret_entry_exists(
    keyring_block_list_garbage
  )
  keyring_value_nonuser <- check_secret_entry_exists(
    keyring_block_service_nonuser
  )
...
testthat::test_that("get_username_from_data works", {
  ...
  username_from_keyring <- get_username_from_data(
    keyring_data_format,
    "secret_one"
  )
...
testthat::test_that("get_password_from_data works", {
  ...
  password_from_keyring <- get_password_from_data(
    keyring_data_format,
    "secret_one"
  )
...
testthat::test_that("construct_guide_message works", {
  ...
  expected_guide_messages <- glue::glue({
    ...
    Service: {example_table$service},
    implied username: {example_table$username}.
